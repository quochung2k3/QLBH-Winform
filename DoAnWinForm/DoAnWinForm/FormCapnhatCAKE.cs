...
{
    public partial class FormCapnhatCAKE : Form
    {
        public FormCapnhatCAKE()
        {
            InitializeComponent();
        }

        private void FormCapnhatCAKE_Load(object sender, EventArgs e)
        {
            ...
            txtTenCAKE = new TextBox[] { txtTenCF1, txtTenCF2, txtTenCF3, txtTenCF4, txtTenCF5 };
            txtGiaCAKE = new TextBox[] { txtGia1, txtGia2, txtGia3, txtGia4, txtGia5 };


            for (int i = 0; i < textFromFile.ToArray().Length; i++)
            {
                string[] arrRes = textFromFile[i].Split('-');
                txtTenCAKE[i].Text = arrRes[0];
                txtGiaCAKE[i].Text = arrRes[1];
        ...
        private void chbXacNhan1_CheckedChanged(object sender, EventArgs e)
        {
